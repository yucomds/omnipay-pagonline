<?php
require_once(dirname(__FILE__) . "/BaseIgfsCgInit.php");
require_once(dirname(__FILE__) . "/InitTerminalInfo.php");
require_once(dirname(__FILE__) . "/../Level3Info.php");
require_once(dirname(__FILE__) . "/../MandateInfo.php");
